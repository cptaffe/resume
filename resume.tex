...
% All Electric Supply
\begin{rSubsection}{All Electic Supply}{June 2016}{Programmer}{Little Rock, AR}

	\item Programmed against Google APIs for Google Apps for Buisness
		on Google App Engine in Go
	\item Submitted several PRs to xTuple (ERP software)
	\item Introduced team to team SaaS solutions like Trello and Slack
	\item Used Linux and GNU tools such as {\tt grep}, {\tt emacs}, {\tt git} \&c, many
		of which I compiled myself
\end{rSubsection}
