...
\begin{rSubsection}{EIT SUPER, UALR}{Summer 2015}{SUPER Scholar}{Little Rock, AR}
	...
	\item Creation of an \href{http://github.com/cptaffe/flamethrower}{Android App}, written in Scala, to interface with a vehicle's OBD-II system via Bluetooth transmitter.
\end{rSubsection}
